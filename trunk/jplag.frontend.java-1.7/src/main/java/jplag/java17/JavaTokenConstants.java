...
public interface JavaTokenConstants extends jplag.TokenConstants {
	...
	final static int SEPARATOR_TOKEN = 1;// @formatter:off
        ...
        // a // at the end of the constant means that there is a test case covering the token
	...
	final static int J_SYNC_BEGIN = 9;          // MISSING - NA
	final static int J_SYNC_END = 10;           // MISSING - NA
	...
	final static int J_IN_CLASS_BEGIN = 32;     // MISSING
	final static int J_IN_CLASS_END = 33;       // MISSING
	final static int J_APPLY = 34;              // MISSING
	final static int J_NEWCLASS = 35;           // MISSING
	final static int J_NEWARRAY = 36;	    // MISSING
	final static int J_ASSIGN = 37;             // MISSING
	...
	final static int J_INIT_BEGIN = 42;         // MISSING
	final static int J_INIT_END = 43;           // MISSING
	...
	final static int J_GENERIC = 50;            // MISSING
	final static int J_ASSERT = 51;             // MISSING - NA

        // ALL MISSING
	final static int J_ANNO = 52;               // MISSING
	final static int J_ANNO_MARKER = 53;        // MISSING
	final static int J_ANNO_M_BEGIN = 54;       // MISSING
	final static int J_ANNO_M_END = 55;         // MISSING
	final static int J_ANNO_T_BEGIN = 56;       // MISSING
	final static int J_ANNO_T_END = 57;         // MISSING
	final static int J_ANNO_C_BEGIN = 58;       // MISSING
	final static int J_ANNO_C_END = 59;         // MISSING

	// new in 1.7
	final static int J_TRY_WITH_RESOURCE = 60;  // MISSING
